...
import com.namelessnetx.ang.dto.EConfigType
import com.namelessnetx.ang.dto.ServerConfig
import com.namelessnetx.ang.dto.V2rayConfig
import com.namelessnetx.ang.dto.V2rayConfig.Companion.DEFAULT_NETWORK
import com.namelessnetx.ang.dto.V2rayConfig.Companion.DEFAULT_PORT
import com.namelessnetx.ang.dto.V2rayConfig.Companion.XTLS
import com.namelessnetx.ang.extension.toast
import com.namelessnetx.ang.util.MmkvManager
import com.namelessnetx.ang.util.MmkvManager.ID_MAIN
...
class ServerActivity : BaseActivity() {
    ...
    private fun bindingServer(config: ServerConfig): Boolean {
        ...
        outbound.getTransportSettingDetails()?.let { transportDetails ->
            sp_header_type.setSelection(Utils.arrayFind(kcpAndQuicTypes, transportDetails[0]))
            et_request_host.text = Utils.getEditable(transportDetails[1])
            et_path.text = Utils.getEditable(transportDetails[2])
        }
        return true
